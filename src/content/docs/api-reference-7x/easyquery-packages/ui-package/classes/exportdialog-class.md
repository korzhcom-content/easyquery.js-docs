---
title: ExportDialog class
slug: api-reference-7x/easyquery-packages/ui-package/classes/exportdialog-class
sidebar:
  order: 100
---
...
---
### show
▸ show(defFormat?: `string`): `Promise`&lt;`void`&gt;

#### Parameters:
- defFormat: `string`, *Default value* = ` null`
