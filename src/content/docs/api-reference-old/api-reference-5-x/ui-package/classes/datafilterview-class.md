...
slug: api-reference-old/api-reference-5-x/ui-package/classes/datafilterview-class
sidebar:
  order: 100
---
...
## Index
### [Public Properties](api-reference-old/api-reference-5-x/ui-package/classes/datafilterview-class#public-properties-1)
- [context](api-reference-old/api-reference-5-x/ui-package/classes/datafilterview-class#context)

### [Public Methods](api-reference-old/api-reference-5-x/ui-package/classes/datafilterview-class#public-methods-1)
- [applyQueryFilter](api-reference-old/api-reference-5-x/ui-package/classes/datafilterview-class#applyqueryfilter)
- [getContext](api-reference-old/api-reference-5-x/ui-package/classes/datafilterview-class#getcontext)
- [init](api-reference-old/api-reference-5-x/ui-package/classes/datafilterview-class#init)

### [Protected Methods](api-reference-old/api-reference-5-x/ui-package/classes/datafilterview-class#protected-methods-1)
- [createDefaultBroker](api-reference-old/api-reference-5-x/ui-package/classes/datafilterview-class#createdefaultbroker)
- [createFilterBarWidget](api-reference-old/api-reference-5-x/ui-package/classes/datafilterview-class#createfilterbarwidget)
- [createResultGridWidget](api-reference-old/api-reference-5-x/ui-package/classes/datafilterview-class#createresultgridwidget)
