...
## Index
### [Properties](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#properties-1)
- [accentActiveColumn](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#accentactivecolumn)
- [activeColumn](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#activecolumn)
- [adjustEntitiesMenuHeight](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#adjustentitiesmenuheight)
- [allowAggrColumns](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#allowaggrcolumns)
- [allowCustomExpressions](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#allowcustomexpressions)
- [allowDragDrop](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#allowdragdrop)
- [allowDuplicates](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#allowduplicates)
- [allowSorting](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#allowsorting)
- [alwaysShowButtons](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#alwaysshowbuttons)
- [attrElementFormat](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#attrelementformat)
- [attrPlacement](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#attrplacement)
- [columnRenderedCallback](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#columnrenderedcallback)
- [customExpressionText](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#customexpressiontext)
- [domWriteItemsId](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#domwriteitemsid)
- [isSubQuery](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#issubquery)
- [menuOptions](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#menuoptions)
- [menuSearchBoxAfter](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#menusearchboxafter)
- [showAddRow](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#showaddrow)
- [showColumnTitles](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#showcolumntitles)
- [showHeader](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#showheader)
- [sortEntities](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#sortentities)
- [titleElementFormat](api-reference-old/api-reference-6x/ui-package/interfaces/columnspaneloptions-interface#titleelementformat)
